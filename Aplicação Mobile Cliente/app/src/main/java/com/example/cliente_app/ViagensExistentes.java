...
import com.example.cliente_app.viagemexistente.viagemexistente;
import com.example.cliente_app.viagemexistente.viagemexistenteadapter;
...
public class ViagensExistentes extends AppCompatActivity {

    private RecyclerView mrecyclerView;
    private viagemexistenteadapter madapterviagem;

    protected ArrayList<viagemexistente> mviagemexistente;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viagensexistentes);
        ...
        mviagemexistente = new ArrayList<>();

        get();
        mviagemexistente.clear();
    }

    private void get() {

        String url = "https://api-pint.herokuapp.com/mobile/viagens/existentes";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, url,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            mviagemexistente = new ArrayList<viagemexistente>();
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                custo = viagem.getString("custo");
                                npessoas = viagem.getString("num_pessoas");

                                mviagemexistente.add(new viagemexistente(id, origem, destino, data, hora, custo, npessoas));
                            }

                            madapterviagem = new viagemexistenteadapter(ViagensExistentes.this, mviagemexistente);
                            mrecyclerView.setAdapter(madapterviagem);
                            if (mviagemexistente.isEmpty()) {
